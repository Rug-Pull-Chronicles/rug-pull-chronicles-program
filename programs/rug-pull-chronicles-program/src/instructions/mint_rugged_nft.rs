...
//     #[account(
//       mut,
//       seeds = [VERIFICATION_SEED, user.key().as_ref()],
//       bump,
//       constraint = rugged_user.owner == user.key() @ RuggedError::RuggedUserNotVerified
//     )]
//     pub rugged_user_mint: Box<Account<'info, RuggedUser>>,
